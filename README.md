...
# Introduction
This is a basic command line tool designed for endangered language speakers to upload and maintain entries for eventual incorporation into Wiktionary. We are currently working with a speaker of San Juan Quiahije Chatino.
